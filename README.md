...
1. Create a machine user under Settings -> Machine users and give it an API key.
...
6. Get a public https URL that reaches this process. To run locally, use `ngrok http 8081`. Otherwise it's
...
7. Create the webhook under Settings -> Webhooks -> Add webhook target, pointed at `$PUBLIC_URL/plain/webhook`,
